...
function PodcastsPage() {
    ...
    useEffect(()=>{
        //onSnapshot() method you constantly listen to a document as explained in the doc: You can listen
  ...
  return (
   <div>
        ...
        <div className='input-wrapper' style={{marginTop:"2rem"}}>
            ...
            :
            <p>{search?"Podcast Not Found":"No current Podcasts On The Platform"}</p>}
        </div>
